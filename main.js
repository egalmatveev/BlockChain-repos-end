...
var calculateHashForBlock = (block) => {
    return calculateHash(block.index, block.previousHash, block.
        timestamp, block.data, block.nonce);
};
...
var mineBlock = (blockData) => {
    ...
    while 
    (parseInt(nextHash) % 10000 !== difficulty)
    {
       ...
       // console.log("\"index\":" + myHashFunction(nextIndex) + ",\"previousHash\":"+previousBlock.hash+
       // "\"timestamp\":"+ myHashFunction(nextTimestamp) +",\"data\":"+blockData+
       // ",\x1b[33mhash: " + nextHash + " \x1b[0m," + "\"difficulty\":"+difficulty+
       // " \x1b[33mnonce: " + nonce + " \x1b[0m ");
    }
